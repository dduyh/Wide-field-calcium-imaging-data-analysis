...
ht = suptitle('Contours of Sources and Sinks of Brain States(300 frames) by HS method');
...
ht = suptitle('Contours of Sources and Sinks of Brain States(300 frames) by CLG method');
set(ht, 'Position', [0.5 -0.02 0],'fontname','Times New Roman','fontsize',18)
